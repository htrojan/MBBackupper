...
namespace Serializer.Annotations
{
  /// <summary>
  ...
  /// <list>
  /// <item><c>NotifyChanged("SerializationTree")</c></item>
  /// <item><c>NotifyChanged(() =&gt; SerializationTree)</c></item>
  /// <item><c>NotifyChanged((VM x) =&gt; x.SerializationTree)</c></item>
  /// <item><c>SetProperty(ref myField, value, "SerializationTree")</c></item>
  /// </list>
  /// </example>
